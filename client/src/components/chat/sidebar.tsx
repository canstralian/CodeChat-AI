...
export default function Sidebar({
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`w-80 bg-white shadow-lg border-r border-gray-200 flex flex-col fixed lg:relative z-50 h-full transform transition-transform duration-300 ease-in-out ${
        ...
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-[#1E293B]">CodeChat AI</h1>
                <p className="text-sm text-gray-500">AI Code Assistant</p>
              </div>
            </div>
            <Button
              variant="ghost"
                ...
                <div
                  ...
                  className={`group p-3 rounded-lg cursor-pointer transition-colors duration-200 border ${
                    selectedChatId === chat.id
                      ? 'bg-[#F1F5F9] border-[#0066CC] border-opacity-50'
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-medium text-[#1E293B] text-sm truncate">
                        {chat.title}
                      </h3>
        ...
        <div className="p-4 border-t border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <p className="font-medium text-[#1E293B] text-sm">Developer</p>
